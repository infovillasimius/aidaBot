...
<li>index data on elasticsearch using the four python scripts provided at https://github.com/infovillasimius/aidaBot/tree/main/data_server (you have to install elasticsearch python client)</li>
